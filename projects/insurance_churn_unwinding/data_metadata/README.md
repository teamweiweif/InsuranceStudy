...
Source project root: `D:\GlobalHealthPolicy Dropbox\Fan Bowei\InsuranceStudy\projects\insurance_churn_unwinding`

This folder is the GitHub-friendly data audit layer for `insurance_churn_unwinding`. It is
